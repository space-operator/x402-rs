...
use serde_json::json;
use x402_common::middleware::PaymentOffers;
...
use x402_common::facilitator_client::{FacilitatorClient, FacilitatorClientError};
use x402_common::price::PriceTag;
    ...
    F: Facilitator + Clone + Send + Sync + 'static,
{
    ...
    fn call(&mut self, req: Request) -> Self::Future {
        ...
        let gate: X402Paygate<F> = X402Paygate {
            facilitator: self.facilitator.clone(),
